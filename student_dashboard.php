...
onclick="openPopup('student_books.php')">
...
onclick="openPopup('notifications.php')">
...
Browse books, discover knowledge and stay updated with announcements easily.
